...
Given the existing growth of LLMs and adjacent foundational models is a result of decades of R&D from major U.S. and Chinese companies and universities, there is an opportunity for Latin America to build companies that enable and manage the efficient deployment of AI systems for enterprises in the region and globally.
...
| --- | --- |
| Foundational Model Creators | Companies building and licensing proprietary AI / ML models (domain agnostic) |
...
The interactions between stakeholders across the value chain cannot be easily mapped because they are not as linear as traditional value chains. For example, End-users, such as enterprises, may directly license from Foundational Model Providers, eliminating Domain-focused Application Developers from the equation. What is certain, however, is the value creation across all levels of the value chain. Stanford's research on foundational model ecosystems illustrates these complex connections between stakeholders.

**Objective and Scope**

The objective of this quick summary is to help categorize the levels of AI development and deployment, as there is value yet to be unlocked across the value chain. A follow-up to this is a market map similar to one created by the Madry Lab at MIT for companies in Latin America and a better understanding of the physical infrastructure value chain that enables AI deployment in the region.

This view excludes the physical infrastructure necessary for energy-efficient, performance-maximizing deployments: GPUs, semiconductors, data centers, cloud services, fiber / 5G networks, and advanced energy technologies, among others. The physical infrastructure layer represents another massive opportunity, especially as current demand far exceeds supply capacity.